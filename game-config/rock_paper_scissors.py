...
def rock_paper_scissors():
    rock_paper_scissors_var.NUMBER_OF_GAMES
    rock_paper_scissors_var.computer_win_count = 0
    rock_paper_scissors_var.player_win_count = 0
    rock_paper_scissors_var.win_count = 0
    ...
    while i <= rock_paper_scissors_var.NUMBER_OF_GAMES:
        if rock_paper_scissors_var.NUMBER_OF_GAMES == 3 and rock_paper_scissors_var.player_win_count == 2:
            winner = rock_paper_scissors_var.USER
